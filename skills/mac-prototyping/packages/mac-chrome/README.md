...
`bodyScroll="contained"` makes the body scroll while the owned header/footer
remain fixed. `headerAccessory` is independently labelled header content,
