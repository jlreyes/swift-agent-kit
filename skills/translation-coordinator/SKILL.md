...
description: >-
  Orchestrates Xcode String Catalog localization: prepares the project
  via LocalizationPlanner, fetches untranslated keys by state, and
  delegates batches to translator subagents that use the translation
  skill. Use when asked to localize an Xcode project or translate String
  Catalogs. Requires the xcode-tools MCP server. (Content extracted from
  your local Xcode on install.)
metadata:
  stub: "true"
