...
description: >-
  Apple's playbook for modernizing UIKit apps for multi-window iOS:
  replacing UIScreen.main and interfaceOrientation usage, migrating from
  application lifecycle to scene lifecycle, and handling safe-area inset
  updates with context-appropriate modern APIs. Use when modernizing or
  reviewing legacy UIKit code. (Content extracted from your local Xcode
  on install.)
metadata:
  stub: "true"
